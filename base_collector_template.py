...
BASE_URL = "https://www.dharitri.com/category/odisha/"
...
def collect_article_urls():
    article_urls = set()
    try:
        for page in range(1, 6):  # Dharitri pages
            ...
            for link in soup.find_all("a", href=True):
                href = link["href"]
                if href.startswith("https://www.dharitri.com/") and "category" not in href and "tag" not in href:
...
def collect_articles():
    print("\n================================")
    print("DHARITRI NAYAGARH COLLECTOR")
    print("================================\n")
