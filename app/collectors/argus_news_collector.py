...
BASE_URL = "https://argusnews.in/category/odisha"
...
def collect_article_urls():
    article_urls = set()
    try:
        for page in range(1, 6):  # ARGUS NEWS pages
            ...
            for link in soup.find_all("a", href=True):
                href = link["href"]
                if href.startswith("https://www.argusnews.in/") and "category" not in href and "tag" not in href:
