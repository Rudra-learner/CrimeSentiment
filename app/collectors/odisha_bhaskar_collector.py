...
BASE_URL = "https://odishabhaskar.in/category/odisha/"
...
def collect_article_urls():
    article_urls = set()
    try:
        for page in range(1, 6):  # ODISHA BHASKAR pages
            ...
            for link in soup.find_all("a", href=True):
                href = link["href"]
                if href.startswith("https://www.odishabhaskar.in/") and "category" not in href and "tag" not in href:
...
def collect_articles():
    print("\n================================")
    print("ODISHA BHASKAR COLLECTOR")
    print("================================\n")
