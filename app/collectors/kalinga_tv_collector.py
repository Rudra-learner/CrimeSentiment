...
BASE_URL = "https://kalingatv.com/state/"
...
def collect_article_urls():
    article_urls = set()
    try:
        for page in range(1, 6):  # KALINGA TV pages
            ...
            for link in soup.find_all("a", href=True):
                href = link["href"]
                if href.startswith("https://www.kalingatv.com/") and "category" not in href and "tag" not in href:
