...
BASE_URL = "https://www.hindustantimes.com/cities/others"
...
def collect_article_urls():
    article_urls = set()
    try:
        for page in range(1, 6):  # HINDUSTAN TIMES pages
            ...
            for link in soup.find_all("a", href=True):
                href = link["href"]
                if href.startswith("https://www.hindustantimes.com/") and "category" not in href and "tag" not in href:
...
def collect_articles():
    print("\n================================")
    print("HINDUSTAN TIMES COLLECTOR")
    print("================================\n")
