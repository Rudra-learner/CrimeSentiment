...
BASE_URL = "https://indianexpress.com/about/odisha/"
...
def collect_article_urls():
    article_urls = set()
    try:
        for page in range(1, 6):  # THE INDIAN EXPRESS pages
            ...
            for link in soup.find_all("a", href=True):
                href = link["href"]
                if href.startswith("https://www.indianexpress.com/") and "category" not in href and "tag" not in href:
...
def collect_articles():
    print("\n================================")
    print("THE INDIAN EXPRESS COLLECTOR")
    print("================================\n")
